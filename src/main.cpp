...
int main(int argc, char * argv[]) {
    if(TEST == 0) {
        ...
        Forme *s1 = new Carre(1000, 1200, 300, Couleur(14, 244, 65, 100), Couleur(255, 62, 146, 100));
        Forme *l1 = new Ligne(0,0, 1999, 1999, Couleur(255, 0, 0, 100));
        Forme *l2 = new Ligne(500, 250, 0, 0, Couleur(0, 255, 0, 100));
        Forme* r1 = new Rectangle(80, 200, 20, 100, Couleur(0,0,255,30), Couleur(255,255,255,100));
        Forme* r2 = new Rectangle(60, 60, 20, 100, Couleur(0,200,0,100), Couleur(255,255,255,100), 0);
